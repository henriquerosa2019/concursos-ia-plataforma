...
const MASTER_STUDY_ENGINE_INSTRUCTION = `
...
function getPilar1Prompt(discipline, subarea, title, professor = "") {
  return `
...
function getPilar2Prompt(discipline, subarea, banca = "Cebraspe", focus = "") {
  return `
${MASTER_STUDY_ENGINE_INSTRUCTION}
...
function getPilar3Prompt(discipline, subarea, focus = "", count = 4) {
  return `
${MASTER_STUDY_ENGINE_INSTRUCTION}
...
function getPilar4Prompt(discipline, subarea, banca = "Cebraspe", focus = "", count = 3) {
