...
def get_pilar1_prompt(discipline, subarea, title, professor=""):
    """
    PILAR 1 — RESUMO ESTRUTURADO & CONCEITOS-CHAVE
    Apostila condensada com a sequência:
...
def get_pilar2_prompt(discipline, subarea, banca="Cebraspe", focus=""):
    """
    PILAR 2 — RAIO-X DAS BANCAS & PEGADINHAS
    Visão de prova, inversões conceituais, termos absolutos e armadilhas.
    """
    return f"""
{MASTER_STUDY_ENGINE_INSTRUCTION}

=============================================================================
ESPECIALIZAÇÃO: PILAR 2 — RAIO-X DAS BANCAS & PEGADINHAS ({banca.upper()})
=============================================================================
...
def get_pilar3_prompt(discipline, subarea, focus="", count=6):
    """
    PILAR 3 — FLASHCARDS ANKI & ESQUEMATIZAÇÃO
    Unidades atômicas de memória + MNEMÔNICOS OBRIGATÓRIOS.
    """
    return f"""
{MASTER_STUDY_ENGINE_INSTRUCTION}
...
def get_pilar4_prompt(discipline, subarea, banca="Cebraspe", focus="", count=5):
    """
    PILAR 4 — MINI-SIMULADO DE FIXAÇÃO
    Questões inéditas, distratores plausíveis, comentários passo a passo e pontos de aprendizagem.
    """
    is_cebraspe = "cebraspe" in banca.lower()
    options_format = (
        '["A) CERTO", "B) ERRADO"] (Estilo Cebraspe Certo/Errado)'
        if is_cebraspe
        else '["A) ...", "B) ...", "C) ...", "D) ...", "E) ..."] (Múltipla Escolha)'
    )
...
=============================================================================
ESPECIALIZAÇÃO: PILAR 4 — MINI-SIMULADO DE FIXAÇÃO ({banca.upper()})
=============================================================================
...
2. Opções no formato: {options_format}.
